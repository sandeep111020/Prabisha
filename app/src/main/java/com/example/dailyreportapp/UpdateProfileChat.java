...
public class UpdateProfileChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_profile_chat);
        ...
        mupdateprofilebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(imagepath!=null)
                {
                    ...
                    userprofile muserprofile =new userprofile(newname,firebaseAuth.getUid(),"hi");
                    ...
                    Intent intent=new Intent(UpdateProfileChat.this,chatActivity.class);
