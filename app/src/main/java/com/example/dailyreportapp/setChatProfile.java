...
import com.example.dailyreportapp.Models.userprofile;
...
public class setChatProfile extends AppCompatActivity {
    ...
    String  token;
    private String Stocken;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_set_chat_profile);
        ...
        msaveprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    Intent intent=new Intent(setChatProfile.this,chatActivity.class);
    ...
    private void sendDataToRealTimeDatabase()
    {
        ...
        Stocken =token.toString().trim();
        FirebaseDatabase firebaseDatabase=FirebaseDatabase.getInstance();
        DatabaseReference databaseReference=firebaseDatabase.getReference(firebaseAuth.getUid());


        userprofile muserprofile=new userprofile(name,firebaseAuth.getUid(),Stocken);
